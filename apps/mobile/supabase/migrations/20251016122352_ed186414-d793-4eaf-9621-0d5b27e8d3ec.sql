...
DROP POLICY IF EXISTS "Investigation photos are publicly accessible" ON storage.objects;
DROP POLICY IF EXISTS "Users can upload their own investigation photos" ON storage.objects;
DROP POLICY IF EXISTS "Users can update their own investigation photos" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete their own investigation photos" ON storage.objects;
